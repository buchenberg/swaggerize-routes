    ...
    Object.keys(api.paths).forEach(function (path) {
        ...
        utils.verbs.forEach(function (verb) {
            ...
            if (operation.hasOwnProperty('x-handler')) {
                var handlerPath = path.resolve(appDir, 'modules/mocks', operation['x-handler'])
                if (fs.existsSync(handlerPath)) {
                    ...
                    debug(`Route building failed for ${verb} at ${path}. ${handlerPath} doesn't exist. Using default handler.`);
